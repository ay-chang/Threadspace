...
const GCP_SERVICES = [
    ...
    },
    {
        id: "compute",
        name: "Compute Engine",
        description: "Virtual machines and compute",
        icon: Server,
        available: false,
    },
    {
...
export default function GcpIntegrationPage() {
    ...
    const handleServiceClick = (serviceId: string) => {
        router.push(`/dashboard/projects/${projectId}/integrations/gcp/${serviceId}`);
    };
    ...
    return (
        <div className="w-full px-4 sm:px-6 lg:px-10 py-6">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-2xl font-semibold">Google Cloud Integration</h1>
                <p className="text-sm text-gray-500">
                    Select a Google Cloud service to view its metrics and data
                </p>
            </div>
